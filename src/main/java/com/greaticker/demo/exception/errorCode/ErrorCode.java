package com.greaticker.demo.exception.errorCode;

public class ErrorCode {
    public static final String DUPLICATED_NICKNAME = "DUPLICATED_NICKNAME";
    public static final String DUPLICATED_HALL_OF_FAME = "DUPLICATED_HALL_OF_FAME";
